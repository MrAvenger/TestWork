            ...
            <form id="warehouses-form">
                ...
                <div class="card shadow">
                    <div class="card-header">
                        <h5 class="card-title">Изменение данных склада</h5>
                    </div>
                            ...
                            <div class="row validated">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="adress" name="adress" value="{{$warehouse->adress}}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#sendBtn").click(
            function() {
                ajaxRequest("{{route('warehouses.update',$warehouse->id)}}", 'PUT', $("#name").val(), $("#adress").val());
            }
        );
